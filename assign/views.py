...
def batch_add_meeting(meeting_detail):
   for meeting in meeting_detail:
      ...
      sent_new_message(
         ...
         "A new meeting is generated by the system for meeting of "+str(Group.objects.get(id=meeting['group']).name)+",between "+ hostname + " and "+ participantname +" please check it in meeting page for details"
      )
